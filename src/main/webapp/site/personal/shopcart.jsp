    ...
    <div id="panel-body" class="panel-body">
        <div class="list-group">
                ...
                <div id="list-goods-<%=good.getId() %>" class="list-group-item">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row detail-goods text-muted">
                                发布者:<%if (user.getName() != null) { %><%=user.getName() %><%} else {%><%=user.getEmail()%><%}%></div>
            ...
            <div class="alert alert-success"
                 role="alert"><%=new String(request.getParameter("info").getBytes("UTF-8"), "UTF-8")%>
            </div>
            <%
                    }
                }

...
<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8" %>
<%@ page
        import="com.luna.saltfish.tools.IntHolder,com.luna.saltfish.tools.*,com.luna.saltfish.constant.*,com.luna.saltfish.dao.*,com.luna.saltfish.entity.*,java.sql.*,java.util.*,java.text.SimpleDateFormat" %>
<%
        ...
        <%
            ...
            if (list.size() != 0) {
                for (Goods good : list) {
                    ...
                    User pUser = userHandle.findById(good.getProducterId());
        %>
        <div onMouseLeave="hide(this,'re-bt-<%=good.getId() %>')" onMouseOver="show(this,'re-bt-<%=good.getId() %>')"
                    ...
                    <div class="row detail-goods">￥<span class="text-danger"><%=Math.round(good.getPrice()) %></span>
                        ...
                        <span class="detail-goods text-muted">　时间：
                                <%
                                    ...
                                    out.print(dateStr);
                                %>
                                <button id="re-bt-<%=good.getId() %>" style="display:none" type="button"

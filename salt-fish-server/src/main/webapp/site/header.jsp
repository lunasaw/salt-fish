...
<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8"
         import="javax.servlet.http.HttpSession,com.luna.saltfish.constant.*,com.luna.saltfish.dao.*,com.luna.saltfish.entity.*,com.luna.saltfish.tools.*" %>
<%
    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<%=basePath %>index.jsp?ceta=0"
               style="font-size: 24px">盐鱼物品交易网站</a>
        </div>
